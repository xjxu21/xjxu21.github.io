...
I am an incoming Ph.D. student in Information Science and Technology at [The University of Tokyo](https://www.i.u-tokyo.ac.jp/index_e.shtml). Prior, I did research with [Shanda AI Research Tokyo](https://jp.shanda.com/), [Tencent AI Lab](https://ailab.tencent.com/ailab/en/index/), [NTU MMLab](https://www.mmlab-ntu.com/) and [Tsinghua IIIS](https://iiis.tsinghua.edu.cn/en/). 

My current research focuses on **Generative AI, including image, video and multimodal generation**. Representative works include:
