...
My research focuses on **Generative AI and Agentic AI**, with applications in multimodal understanding and generation. Representative works include:

- **Generative AI**: POSTA(movie poster generation, CVPR 25), BEV to Street View(street-view images generation, ICRA 24), VBench++(benchmarking video generative models, Arxiv 25)
- **Agentic AI** : PreGenie(visual presentation generation, EMNLP 25), Orchestrating Audio(agents for long-video audio generation, EMNLP 25)
